...
const { page } = useData()
const props = defineProps<{ fileTime?: string }>()
const date = computed(() => {
  const ts = props.fileTime || page.value.lastUpdated
...
<template>
    <div class="word">
        <p>
            ...
            更新: {{ date.toLocaleString('zh-CN', { year: 'numeric', month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit', second: '2-digit', hour12: false }) }}
